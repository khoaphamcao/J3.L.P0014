<%-- 
    Document   : signup
    Created on : Jan 26, 2021, 8:50:04 PM
    Author     : Khoa Pham
--%>
        ...
        <div class="signup__container">
            <div class="container__child signup__thumbnail">
                <div class="thumbnail__logo">
                    ...
                    <h1 class="logo__text">Quiz</h1>
                </div>
                <div class="thumbnail__content text-center">
                    <h1 class="heading--primary">Welcome to Check Intelligent Program.</h1>
                    <h2 class="heading--secondary">Are you ready to join the test?</h2>
                </div>
            ...
            <div class="container__child signup__form">
                <form action="signUp" method="POST">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="txtFullname" id="username" required value="${param.txtFullname}" />
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input class="form-control" type="email" name="txtEmail" id="email" required value="${param.txtEmail}" />
                    </div>
                    <div class="form-group">
                        <label for="password">Password</label>
                        <input class="form-control" type="password" name="txtPassword" id="password" required />
                    </div>
                    <div class="form-group">
                        <label for="passwordRepeat">Repeat Password</label>
                        <input class="form-control" type="password" name="txtRepeatPassword" id="passwordRepeat" required />
                    </div>
                    <div class="m-t-lg">
                        <ul class="list-inline">
                            ...
                            <li>
                                <a class="signup__link" href="login.jsp">I am already a student</a>
                            </li>
                            <font color="red">
