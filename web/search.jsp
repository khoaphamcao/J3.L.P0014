<%-- 
    Document   : search1
    Created on : Jan 31, 2021, 11:59:45 AM
    Author     : Khoa Pham
--%>
...
<html>
    ...
    <body>
        ...
        <c:set var="listQuest" value="${requestScope.LIST}"/>
    ...
    <div class="paging">
        <c:forEach var="i" begin="1" end="${requestScope.END_PAGE}">
            <a href="SearchServlet?index=${i}&searchValue=${param.searchValue}&status=${param.status}&subject=${param.subject}">${i}</a>
        </c:forEach>
    </div>
